...
|----------------|--------------|
|`fix(workflows): stop graphite breaking when too much pressure applied`   | Patch Release |
|`feat(compile): add 'graphiteWidth' option`                             | Minor Release |
|`perf(browser): remove graphiteWidth option`                            | Major Release |
|`BREAKING CHANGE: the graphiteWidth option has been removed`           | Major Release |
